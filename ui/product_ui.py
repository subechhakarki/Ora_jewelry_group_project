...
class ProductFormDialog(ctk.CTkToplevel):
    ...
    def __init__(self, parent, product=None, on_saved=None):
        ...
        self.image_path_db = None  # stored path in db
        ...
        # Name
        ctk.CTkLabel(container, text="Product Name", **get_label_style("normal")).pack(anchor="w", padx=18)
        self.name_entry = ctk.CTkEntry(container, width=500, **get_input_style())
        self.name_entry.pack(padx=18, pady=(6, 10))

        # Price
        ctk.CTkLabel(container, text="Price", **get_label_style("normal")).pack(anchor="w", padx=18)
        self.price_entry = ctk.CTkEntry(container, width=500, **get_input_style())
        self.price_entry.pack(padx=18, pady=(6, 10))

        # Quantity
        ctk.CTkLabel(container, text="Quantity / Stock", **get_label_style("normal")).pack(anchor="w", padx=18)
        self.qty_entry = ctk.CTkEntry(container, width=500, **get_input_style())
        self.qty_entry.pack(padx=18, pady=(6, 10))

        # Image picker row
        img_row = ctk.CTkFrame(container, fg_color="transparent")
        img_row.pack(fill="x", padx=18, pady=(6, 10))
        ...
        # Description
        ctk.CTkLabel(container, text="Description (optional)", **get_label_style("normal")).pack(anchor="w", padx=18)
        ...
        self.desc_box.pack(padx=18, pady=(6, 10))
        ...
        save_btn = ctk.CTkButton(
            btn_row,
            text="Create" if product is None else "Save Changes",
            command=self.save,
            width=180,
